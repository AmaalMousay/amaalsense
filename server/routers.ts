...
export const appRouter = router({
  ...
  // DCFT endpoints have been migrated to engine.* (calculateDCF, getEmotionalForecast, checkAlerts, getTheoryInfo, analyzeDCFT)
  // All DCFT functionality now flows through the unified Network Engine
