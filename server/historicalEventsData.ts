...
,
  ...
  {
    eventName: 'Indian Ocean Tsunami 2004',
    eventDescription: '9.1 magnitude earthquake triggers massive tsunami',
    eventCategory: 'environmental',
    eventDate: '2004-12-26',
    country: 'Indonesia',
    estimatedGMI: 10,
    estimatedCFI: 98,
    estimatedHRI: 20,
    emotionalVector: { joy: 5, fear: 98, anger: 40, sadness: 98, hope: 20, curiosity: 60 },
    gdpImpact: -8,
    shortTermOutcome: 'Immediate impacts recorded',
    mediumTermOutcome: 'Medium-term consequences',
    longTermOutcome: 'Long-term implications',
    ...
    impacts: {
      political: 'International aid coordination, disaster response, rebuilding',
      economic: '$15B damage, infrastructure collapse, tourism disruption',
      social: '230,000+ deaths, 1.7M+ displaced, orphaned children, global solidarity'
    },
  },
,
  {
...
,
  ...
  {
    eventName: 'Rwandan Genocide',
    eventDescription: 'Hutu extremists massacre 800,000+ Tutsis and moderate Hutus',
    eventCategory: 'conflict',
    eventDate: '1994-04-07',
    country: 'Rwanda',
    estimatedGMI: 5,
    estimatedCFI: 99,
    estimatedHRI: 10,
    emotionalVector: { joy: 5, fear: 99, anger: 95, sadness: 99, hope: 10, curiosity: 75 },
    gdpImpact: -50,
    shortTermOutcome: 'Immediate impacts recorded',
    mediumTermOutcome: 'Medium-term consequences',
    longTermOutcome: 'Long-term implications',
    sources: ['Reuters', 'BBC', 'AP News', 'Al Jazeera', 'Historical Archives'],
    impacts: {
      political: 'International community criticized for inaction, ICC established, war crimes trials',
      economic: 'Economy destroyed, infrastructure ruined, 90% of population displaced or killed',
      social: '800,000+ deaths in 100 days, 2M+ refugees, trauma and PTSD widespread, reconciliation difficult'
    },
  },
  {
    eventName: 'Asian Financial Crisis',
    eventDescription: 'Currency crisis spreads across Asia, triggering regional economic collapse',
    eventCategory: 'economic',
    eventDate: '1997-07-02',
    country: 'Thailand',
    estimatedGMI: 20,
    estimatedCFI: 85,
    estimatedHRI: 30,
    emotionalVector: { joy: 15, fear: 85, anger: 70, sadness: 75, hope: 30, curiosity: 75 },
    gdpImpact: -15,
    shortTermOutcome: 'Immediate impacts recorded',
    mediumTermOutcome: 'Medium-term consequences',
    longTermOutcome: 'Long-term implications',
    sources: ['Reuters', 'BBC', 'AP News', 'Al Jazeera', 'Historical Archives'],
    impacts: {
      political: 'IMF intervention, government instability, political reforms demanded',
      economic: 'Thai baht -50%, regional GDP -10%, unemployment 25%, poverty increases',
      social: 'Millions unemployed, social safety nets collapse, suicide rates spike, social unrest'
    },
  },
  {
  ...
  {
    eventName: 'Indian Ocean Tsunami 2004',
    eventDescription: 'Magnitude 9.1 earthquake triggers massive tsunami across Indian Ocean',
    eventCategory: 'environmental',
    eventDate: '2004-12-26',
    country: 'Indonesia',
    estimatedGMI: 15,
    estimatedCFI: 90,
    estimatedHRI: 35,
    emotionalVector: { joy: 10, fear: 90, anger: 50, sadness: 95, hope: 35, curiosity: 80 },
    gdpImpact: -3,
    shortTermOutcome: 'Immediate impacts recorded',
    mediumTermOutcome: 'Medium-term consequences',
    longTermOutcome: 'Long-term implications',
    sources: ['Reuters', 'BBC', 'AP News', 'Al Jazeera', 'Historical Archives'],
    impacts: {
      political: 'International aid coordination, disaster response mechanisms improved',
      economic: '$15B+ damages, tourism collapse, reconstruction costs high',
      social: '230,000+ deaths, 1.7M+ displaced, generational trauma, global compassion response'
    },
  },
  {
  ...
  {
    eventName: 'Arab Spring Begins',
    eventDescription: 'Pro-democracy uprisings spread across Middle East and North Africa',
    eventCategory: 'political',
    eventDate: '2010-12-17',
    country: 'Tunisia',
    estimatedGMI: 65,
    estimatedCFI: 75,
    estimatedHRI: 80,
    emotionalVector: { joy: 75, fear: 75, anger: 60, sadness: 60, hope: 85, curiosity: 85 },
    gdpImpact: -5,
    shortTermOutcome: 'Immediate impacts recorded',
    mediumTermOutcome: 'Medium-term consequences',
    longTermOutcome: 'Long-term implications',
    sources: ['Reuters', 'BBC', 'AP News', 'Al Jazeera', 'Historical Archives'],
    impacts: {
      political: 'Multiple governments fall, civil wars emerge, regional instability increases',
      economic: 'Tourism collapses, investment flees, economies contract 5-15%, unemployment rises',
      social: '500,000+ deaths, millions displaced, social upheaval, generational change'
    },
  },
  {
    eventName: 'Brexit Vote',
    ...
    estimatedCFI: 70,
    estimatedHRI: 50,
    emotionalVector: { joy: 50, fear: 70, anger: 65, sadness: 55, hope: 50, curiosity: 80 },
    gdpImpact: -2,
    shortTermOutcome: 'Immediate impacts recorded',
    mediumTermOutcome: 'Medium-term consequences',
    longTermOutcome: 'Long-term implications',
    sources: ['Reuters', 'BBC', 'AP News', 'Al Jazeera', 'Historical Archives'],
    impacts: {
      political: 'UK-EU separation, trade negotiations, political polarization increases',
      economic: 'Pound -15%, GDP growth slows, investment uncertainty, trade friction',
      social: 'Nation divided, immigration debate, generational conflict, social polarization'
    },
  },
  {
