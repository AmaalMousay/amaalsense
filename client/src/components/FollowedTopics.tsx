        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="flex gap-2 flex-wrap">
              {[
                { value: 'latest' as const, label: '' },
                { value: 'followers' as const, label: ' ' },
                { value: 'emotion' as const, label: ' ' }
              ].map(({ value, label }) => (
                <button
                  key={value}
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4 text-xs text-gray-600">
                  ...
                  <span>⏱️ {Math.floor((Date.now() - topic.latestUpdate.getTime()) / (1000 * 60))} </span>
                </div>
              </div>
              ...
              <div className="flex flex-col items-end gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    title={topic.isNotificationEnabled ? ' ' : ' '}
                  >
                    {topic.isNotificationEnabled ? (
                    ...
                    {showSettings === topic.id && (
                      <div className="absolute right-0 top-full mt-2 bg-white border border-gray-200 rounded shadow-lg z-10 min-w-max">
                        <div className="p-2 space-y-1">
                          <p className="text-xs font-semibold text-gray-700 px-2 py-1"> </p>
