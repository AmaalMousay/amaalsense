...
const COUNTRIES = [
  // MENA
  { code: "LY", nameAr: "", nameEn: "Libya", region: "MENA" },
  { code: "EG", nameAr: "", nameEn: "Egypt", region: "MENA" },
  { code: "SA", nameAr: "", nameEn: "Saudi Arabia", region: "MENA" },
  { code: "AE", nameAr: "", nameEn: "UAE", region: "MENA" },
  { code: "QA", nameAr: "", nameEn: "Qatar", region: "MENA" },
  { code: "KW", nameAr: "", nameEn: "Kuwait", region: "MENA" },
  { code: "BH", nameAr: "", nameEn: "Bahrain", region: "MENA" },
  { code: "OM", nameAr: "", nameEn: "Oman", region: "MENA" },
  { code: "YE", nameAr: "", nameEn: "Yemen", region: "MENA" },
  { code: "JO", nameAr: "", nameEn: "Jordan", region: "MENA" },
  { code: "LB", nameAr: "", nameEn: "Lebanon", region: "MENA" },
  { code: "SY", nameAr: "", nameEn: "Syria", region: "MENA" },
  { code: "IQ", nameAr: "", nameEn: "Iraq", region: "MENA" },
  { code: "PS", nameAr: "", nameEn: "Palestine", region: "MENA" },
  { code: "TN", nameAr: "", nameEn: "Tunisia", region: "MENA" },
  { code: "DZ", nameAr: "", nameEn: "Algeria", region: "MENA" },
  { code: "MA", nameAr: "", nameEn: "Morocco", region: "MENA" },
  { code: "SD", nameAr: "", nameEn: "Sudan", region: "MENA" },
  // Europe
  { code: "GB", nameAr: "", nameEn: "United Kingdom", region: "Europe" },
  { code: "FR", nameAr: "", nameEn: "France", region: "Europe" },
  { code: "DE", nameAr: "", nameEn: "Germany", region: "Europe" },
  { code: "IT", nameAr: "", nameEn: "Italy", region: "Europe" },
  { code: "ES", nameAr: "", nameEn: "Spain", region: "Europe" },
  { code: "NL", nameAr: "", nameEn: "Netherlands", region: "Europe" },
  { code: "SE", nameAr: "", nameEn: "Sweden", region: "Europe" },
  { code: "NO", nameAr: "", nameEn: "Norway", region: "Europe" },
  { code: "RU", nameAr: "", nameEn: "Russia", region: "Europe" },
  { code: "UA", nameAr: "", nameEn: "Ukraine", region: "Europe" },
  { code: "TR", nameAr: "", nameEn: "Turkey", region: "Europe" },
  // Americas
  { code: "US", nameAr: "", nameEn: "United States", region: "Americas" },
  { code: "CA", nameAr: "", nameEn: "Canada", region: "Americas" },
  { code: "MX", nameAr: "", nameEn: "Mexico", region: "Americas" },
  { code: "BR", nameAr: "", nameEn: "Brazil", region: "Americas" },
  { code: "AR", nameAr: "", nameEn: "Argentina", region: "Americas" },
  // Asia
  { code: "CN", nameAr: "", nameEn: "China", region: "Asia" },
  { code: "JP", nameAr: "", nameEn: "Japan", region: "Asia" },
  { code: "KR", nameAr: " ", nameEn: "South Korea", region: "Asia" },
  { code: "IN", nameAr: "", nameEn: "India", region: "Asia" },
  { code: "PK", nameAr: "", nameEn: "Pakistan", region: "Asia" },
  { code: "ID", nameAr: "", nameEn: "Indonesia", region: "Asia" },
  // Africa
  { code: "NG", nameAr: "", nameEn: "Nigeria", region: "Africa" },
  { code: "ZA", nameAr: " ", nameEn: "South Africa", region: "Africa" },
  { code: "KE", nameAr: "", nameEn: "Kenya", region: "Africa" },
  // Oceania
  { code: "AU", nameAr: "", nameEn: "Australia", region: "Oceania" },
  { code: "NZ", nameAr: "", nameEn: "New Zealand", region: "Oceania" },
];
...
const EMOTION_LABELS_AR: Record<string, string> = {
  ...
  sadness: 'Sadness', hope: '', curiosity: '',
};
