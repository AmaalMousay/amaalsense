...
const steps = [
  ...
  },
  {
    ...
    descriptionAr: "        (70%) Analysis    (30%)      Emotions.",
  ...
  },
  {
    ...
    descriptionAr: "     6  : Joy Fear Anger Sadness   -    .",
  ...
  },
  {
    ...
    descriptionAr: "      DCFT      : GMI ( ) CFI (Fear) HRI ().",
...
const hybridEngineFeatures = [
  {
    ...
    descriptionAr: "   DCFT (   ) -     Analysis Emotions .",
  ...
  },
  {
    ...
    descriptionAr: "   Language  Emotions     .",
